...
# ~~~~~~~~~~~ 1) S3 ~~~~~~~~~~~
aws s3 rm s3://dtq-bucket-reactjs/ --recursive
aws s3api delete-bucket --bucket dtq-bucket-reactjs
...
# ~~~~~~~~~~~ 13) CICD ~~~~~~~~~~~
## ~~~~~~~~~~~ pipeline!!!
aws codepipeline delete-pipeline --name DTQPipelinedReactJS 

## ~~~~~~~~~~~ deploy!!!
# aws deploy delete-application --application-name <DEPLOYAPP_NAME> 

## ~~~~~~~~~~~ build!!!
aws codebuild delete-project --name DTQCodeBuildReactJS 
